...
protected:
	bool find_maze_path(int r, int c, int z);
	vector<string> solution;
	int maze_grid[ROW_SIZE][COL_SIZE][LAYER_SIZE];
	int temp_maze[ROW_SIZE][COL_SIZE][LAYER_SIZE]; // To hold values
	//-----------------------------------------------------------------------------------------
};